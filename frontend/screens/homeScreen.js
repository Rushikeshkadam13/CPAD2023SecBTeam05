...
import UseUser from '../UserLogin/UserContext';
import {
  Platform,
  NativeModules,
  StyleSheet,
...
const ProfileTab = () => {
  ...
  useEffect(async () => {
    await fetch(api)
      ...
      .then((data) => {
        const LogedInUser = data.find((user) => user.uid === "2@gmail.com");
    ...
    <View style={styles.container}>
      ...
      <Text
        style={[
          styles.balancestyle,
          {
            color: targetUser && targetUser.balance >= 0 ? "#18c40c" : "#ff3333",
          },
        ]}
      >
...
const HomeScreen = ({ navigation }) => {
  ...
  // useEffect(async () => {
  //   console.log("try..........................", route.params)
  //   await fetch(api)
  //     .then((response) => response.json())
  //     .then((data) => {
  //       const LogedInUser = data.find((user) => user.uid === "1@gmail.com");
  //       console.log(LogedInUser);
  //       setUsers(LogedInUser);
  //     })
  //     .catch((error) => console.error("Error fetching balance:", error));
